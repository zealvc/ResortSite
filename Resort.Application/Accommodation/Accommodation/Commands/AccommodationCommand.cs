...
{
    public class AccommodationCommand : Repository<AccommodationModel>, IAccommodationQuery
    {
        public AccommodationCommand(ResortSiteDbContext context) : base(context)
        {
