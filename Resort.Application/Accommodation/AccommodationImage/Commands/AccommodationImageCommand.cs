...
{
    public class AccommodationImageCommand : Repository<AccommodationImageModel>, IAccommodationImageQuery
    {
        public AccommodationImageCommand(ResortSiteDbContext context) : base(context)
        {
