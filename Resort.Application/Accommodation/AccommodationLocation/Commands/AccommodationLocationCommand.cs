...
{
    public class AccommodationLocationCommand : Repository<AccommodationLocationModel>, IAccommodationLocationQuery
    {
        public AccommodationLocationCommand(ResortSiteDbContext context) : base(context)
        {
