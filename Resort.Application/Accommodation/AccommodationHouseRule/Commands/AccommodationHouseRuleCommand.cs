...
{
    public class AccommodationHouseRuleCommand : Repository<AccommodationHouseRuleModel>
    {
        public AccommodationHouseRuleCommand(ResortSiteDbContext context) : base(context)
        {
